                    ...
                    <div className="col-lg-12  d-flex justify-content-center">
                        <div className="w-100">
                            ...
                            <div className="mt-2 mb-2">
                                <form action="">
                                    <input type=" text " className="border border-rounded-pill form-control updateStatusInput" placeholder="update Your Status" />
                                </form>
                            </div>
                            <div className="profileList">
                                <ul className="list-unstyled">
                                    <li>
                                        <div className="">
                                            <NavLink className=" nav-link d-flex align-items-center ProfileLink" href={"#"} >
                            ...
                            <div>
                                <div className="d-flex justify-content-center mb-2">
                                    <button className="btn btn-outline ProfileSignOutBtn"> Sign out </button>
                                </div>
                            </div>
